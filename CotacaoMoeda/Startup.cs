...
using CotacaoMoeda.Repositorio;
...
namespace CotacaoMoeda
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MoneyContext>(options => options.UseNpgsql("Server=127.0.0.1;Port=5432;Database=CotacaoMoeda;User Id=postgres;Password=admin;"));
